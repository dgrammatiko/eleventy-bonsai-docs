...
To add a auxiliary navigation item to your site (in the upper right on all pages), add it to the `aux_nav` [configuration option]({{ site.baseurl }}docs/configuration.md#aux-nav) in your site's `_config.yml` file.
